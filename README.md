...
| <a id="ADRVUSBC">ADRVUSBC</a> | REVIVE USB Type-C                                                    | [製品ページ][ADRVUSBC_HP] | [サポートページ][ADRVUSBC_SP] |
...
[ADRVMICR2_SP]: https://bit-trade-one.github.io/ADRVMIC-REVIVE-USB-Micro/

[ADRVUSBC_HP]: https://bit-trade-one.co.jp/adrvusbc/
[ADRVUSBC_SP]: https://github.com/bit-trade-one/ADRVUSBC-REVIVE-USB-Type-C/
...
AssemblyDeskは閉鎖したため、投稿されていたユーザ様作成の成果物を  
以下ページでアーカイブしています。
